...
public class ExtStrictIso extends AbstractIsoChecker {

    public ExtStrictIso(OWLReasonerFactory rf) {
        super(rf);
    }
	...
	OWLReasoner j2 = rf.createReasoner(ontoman.createOntology(e2.getAxioms()));
	Boolean E1ENT = j1.isEntailed(e1.getEntailment);
	Boolean E2ENT = j2.isEntailed(e2.getEntailment);
...
//        System.out.println(vars);
        return checker.isEntailed(et, jt, vars).equals(entval);
    }
